...
//        handler = new CameraHandler(getLooper(), uiCallback);
    ...
    private static final class CameraHandler extends Handler {
        ...
        private void processBitmap(final Camera1 camera1, byte[] data) {
            ...
            int cameraRotation = camera1.calcCameraRotation();
            Matrix matrix = camera1.getImageTransformMatrix(cameraRotation);
            ...
            uiHandler.post(new Runnable() {
                ...
                public void run() {
                    camera1.startPreview();
                    camera1.cameraStatusCallback.onBitmapProcessed(rotatedBitmap, cameraRotation);
                }
            });
        }
    }
