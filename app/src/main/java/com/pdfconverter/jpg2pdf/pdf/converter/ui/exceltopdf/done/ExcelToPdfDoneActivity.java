package com.pdfconverter.jpg2pdf.pdf.converter.ui.exceltopdf.done;
...
import com.pdfconverter.jpg2pdf.pdf.converter.ui.exceltopdf.ExcelToPdfNavigator;
import com.pdfconverter.jpg2pdf.pdf.converter.ui.exceltopdf.ExcelToPdfViewModel;
...
import com.pdfconverter.jpg2pdf.pdf.converter.utils.excel.ExcelToPdfListener;
import com.pdfconverter.jpg2pdf.pdf.converter.utils.excel.ExcelToPdfManager;
...
public class ExcelToPdfDoneActivity extends BaseBindingActivity<ActivityCreatePdfDoneBinding, ExcelToPdfViewModel> implements ExcelToPdfListener, ExcelToPdfNavigator {
    ...
    private ExcelToPdfManager mTaskManager;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mOptions = new Gson().fromJson(json, ExcelToPDFOptions.class);
        ...
        RenameFileDialog renameFileDialog = new RenameFileDialog(this, displayName, new RenameFileDialog.RenameFileListener() {
            ...
            public void onSubmitName(String name) {
                ...
                if (result == -2 || result == 0) {
                    ...
                    SnackBarUtils.getSnackbar(ExcelToPdfDoneActivity.this, getString(R.string.duplicate_video_name) + ": " + name).show();
                } else {
                    SnackBarUtils.getSnackbar(ExcelToPdfDoneActivity.this, getString(R.string.rename_file_success)).show();
                    ...
                    mExcelToPdfViewModel.updateSavedData(tempOldDir, mOutputPath);
                }
            }
    ...
    public void onCreateSuccess(String finalOutput) {
        runOnUiThread(() -> {
            ...
            mExcelToPdfViewModel.saveRecent(mOutputPath, getString(R.string.excel_to_pdf));
            setForLayoutView();
        });
    ...
    private void startCreatePdf() {
        mTaskManager = new ExcelToPdfManager(this, this, mOptions);
