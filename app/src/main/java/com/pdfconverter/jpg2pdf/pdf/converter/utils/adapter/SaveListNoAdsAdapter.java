...
public class SaveListNoAdsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SaveListNoAdsAdapter(OnFileItemWithOptionClickListener listener) {
