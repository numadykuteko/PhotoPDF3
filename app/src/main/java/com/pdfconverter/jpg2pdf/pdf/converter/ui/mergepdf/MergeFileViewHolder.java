...
public class MergeFileViewHolder extends RecyclerView.ViewHolder {
    ...
    public MergeFileViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bindView(int position, DocumentData documentData, OnItemFileActionListener listener) {
        ...
        mDragView.setOnTouchListener((View view, MotionEvent motionEvent) -> {
            if (motionEvent.getActionMasked() == MotionEvent.ACTION_DOWN && listener != null) {
                ...
                listener.onClickSwap(MergeFileViewHolder.this);
            }
